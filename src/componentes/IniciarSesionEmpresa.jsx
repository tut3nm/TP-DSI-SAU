    ...
    <>
      <header>
        <div className="top-bar">
          <img src="../pics/logo-utn.png" alt="Logo UTN" />
          <img src="../pics/redes-sociales.png" alt="Redes Sociales" />
        </div>
        <nav>
          <ul>
      ...
      <main>
        <div className="login-box">
          ...
          <form>
            <input type="text" placeholder="Ingrese su mail o nombre" />
...
export default IniciarSesionEmpresa;
