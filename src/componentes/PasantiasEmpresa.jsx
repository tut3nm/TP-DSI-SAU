...
function PasantiasEmpresa() {
  return (
    <>
      ...
      <main>
        <h1>Empresas - Pasantías</h1>
        <div className="acciones">
          <button>Administrar pasantías</button>
          <button>Agregar nueva pasantía</button>
          <button>Encuesta de rendimiento estudiantil</button>
        </div>
      </main>
      <footer>
...
export default PasantiasEmpresa;
