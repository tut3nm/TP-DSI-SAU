...
function BecasEstudiante() {
  return (
    <>
      ...
      <main>
        <h1>Estudiantes - Becas</h1>
        <div className="botones-becas">
          <button>PROGRESAR</button>
          <button>Becas Manuel Belgrano</button>
          <button>Becas SAE</button>
        </div>
      </main>
      <footer>
...
export default BecasEstudiante;
